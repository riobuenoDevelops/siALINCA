...
export default function BasicActionsButtonGroup({ disabled, onEdit, onDelete, route, token, itemMutate, withoutDelete }) {
  ...
  return <>
    <Whisper placement="bottom" trigger="hover" speaker={<Tooltip>Editar</Tooltip>}>
      <IconButton size="md" appearence="primary" circle style={{ marginRight: '0.5rem' }} className="bg-default"
