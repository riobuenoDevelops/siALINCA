...
async function deleteMethodHandler(req, res) {
  ...
  try {
    const deletedItemId = await ElectroDeviceService.deleteElectroDevice({ id });
...
async function updateMethodHandler(req, res) {
  ...
  try {
    const updatedItemId = await ElectroDeviceService.updateElectroDevice({ id, electroDevice: req.body });
