...
import EnamelwareDevice from "../../../../../services/Enamelware";
...
async function deleteMethodHandler(req, res) {
  ...
  try {
    const deletedItemId = await EnamelwareDevice.deleteEnamelware({ id });
...
async function updateMethodHandler(req, res) {
  ...
  try {
    const updatedItemId = await EnamelwareDevice.updateEnamelware({ id, enamelware: req.body });
